                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3.5 whitespace-nowrap">
                          <p className="text-slate-400">{lead.totalExperienceYears ?? (lead.yearsExperience != null ? `${lead.yearsExperience} yrs` : '—')}</p>
                        ...
                        {/* Consultation */}
                        <td className="px-4 py-3.5">
                          {(lead.consultationBooked || (lead.consultationStatus && lead.consultationStatus !== 'NONE' && lead.consultationStatus !== 'none')) ? (
