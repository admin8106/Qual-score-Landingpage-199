...
import com.qualscore.qualcore.service.impl.AdminLeadServiceImpl;
...
public class CrmPayloadBuilder {
    ...
    private final AdminLeadServiceImpl adminLeadServiceImpl;
    ...
    public CrmPayload build(
        ...
        LeadPriority priority = adminLeadServiceImpl.derivePriority(tags);
